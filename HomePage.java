...
public class HomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Jupitor - Database Comparer Tool");
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("Data Options"));

        jCheckBox1.setSelected(true);
        jCheckBox1.setText("Toggle All");
        ...
        jRadioButton3.setText("CLOB");

        buttonGroup2.add(jRadioButton4);
        jRadioButton4.setSelected(true);
        jRadioButton4.setText("Non-CLOB");
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/Capture.PNG"))); // NOI18N
        ...
        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/62529E25.PNG"))); // NOI18N
            ...
            if (count == 2) {
                ...
                if (jRadioButton1.isSelected()) {
                    ...
                    if (jCheckBox2.isSelected() && jCheckBox2.isEnabled()) {
                        ...
                        if (!jCheckBox11.isSelected() && !jCheckBox10.isSelected() && !jCheckBox9.isSelected() && !jCheckBox8.isSelected() && !jCheckBox6.isSelected()) {
                            jButton3.setEnabled(true);
            ...
            try {
                if (sessionParameters != null) {
                    ...
                    if (DatabaseHelper.testDBConnection(targetDB)) {
                        ...
                        jLabel17.setForeground(Color.red);
                        jLabel17.setText("Error: Probably the connection details are old/invalid of " + target + ". Also please make sure to connect required tunnel if any.");
                    }
                }
            ...
            try {
                if (sessionParameters != null) {
                    ...
                    if (DatabaseHelper.testDBConnection(sourceDB)) {
                        ...
                        jLabel17.setForeground(Color.red);
                        jLabel17.setText("Error: Probably the connection details are old/invalid of " + source + "...");
                    }
                }
            } catch (JAXBException | SQLException ex) {
                Logger.getLogger(HomePage.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jCheckBox6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox6ActionPerformed
        if (jCheckBox6.isSelected()) {
            if (jCheckBox8.isSelected() && jCheckBox9.isSelected() && jCheckBox10.isSelected()
                    && jCheckBox11.isSelected() && !jCheckBox2.isSelected()) {
                jCheckBox2.setSelected(true);
            }
        } else {
            if (jCheckBox2.isSelected()) {
    ...
    private void jCheckBox11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox11ActionPerformed
        if (jCheckBox11.isSelected()) {
            if (jCheckBox8.isSelected() && jCheckBox9.isSelected() && jCheckBox10.isSelected()
                    && jCheckBox6.isSelected() && !jCheckBox2.isSelected()) {
                jCheckBox2.setSelected(true);
            }
        } else {
            if (jCheckBox2.isSelected()) {
